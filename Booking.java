...
public class Booking {
	public static void movietime(float Total, int NoOfSeats) {
	...
	public static void Time(LocalDate A, LocalDate B, float Total, int NoOfSeats) { // convert to the variables form
		Scanner sc = new Scanner(System.in);
	   System.out.println("SHOW TIME : \n 1.Morning show = 10:15:00am-12:45:00pm \n 2.Evening show = 05:00:00pm-07:30:00pm \n 3.Night show = 10:00:00pm-12:30:00am \n");
		System.out.println("please enter the show time [HH:MM:SS]  :"); // enter the correct pick up time and it will bw
																		// choose before timing
		String time = sc.next();
